	...
	public void paintComponent(Graphics2D g) {
		if (isAlive) {
			switch (way) {
				case "up":
					if (animation)
						g.drawImage(right1, x, y, gp.tileSize, gp.tileSize, null);
					break;
				case "down":
				...
				case "left":
					if (animation)
						...
						g.drawImage(left2, x, y, gp.tileSize, gp.tileSize, null);
					break;
				case "right":
					if (animation)
						g.drawImage(right1, x, y, gp.tileSize, gp.tileSize, null);
					else
						g.drawImage(right2, x, y, gp.tileSize, gp.tileSize, null);
					break;
				case "stand":
