...
public class RedMonster extends Entity implements Runnable {
	...
	public void paintComponent(Graphics2D g) {
		if (isAlive) {
			switch (way) {
				case "up":
					if (animation)
						g.drawImage(right1, x - speed, y - speed, gp.tileSize, gp.tileSize, null);
					else
						g.drawImage(right2, x - speed, y - speed, gp.tileSize, gp.tileSize, null);
					break;
				case "down":
					if (animation)
						g.drawImage(left1, x, y + speed, gp.tileSize, gp.tileSize, null);
					else
						g.drawImage(left2, x - speed, y + speed, gp.tileSize, gp.tileSize, null);
					break;
				case "left":
					if (animation)
						g.drawImage(left1, x + speed, y, gp.tileSize, gp.tileSize, null);
					else
						g.drawImage(left2, x + speed, y, gp.tileSize, gp.tileSize, null);
					break;
				case "right":
					if (animation)
						g.drawImage(right1, x - speed, y, gp.tileSize, gp.tileSize, null);
					else
						g.drawImage(right2, x - speed, y, gp.tileSize, gp.tileSize, null);
					break;
				case "stand":
	...
	public void setLocation() {
		...
		if (gp.manage.map[b / gp.tileSize][a / gp.tileSize] == 0 && b / gp.tileSize != 2 && b / gp.tileSize != 1
				&& a / gp.tileSize != 1 && a / gp.tileSize != 2) {
			x = a;
			y = b;
		} else {
			setLocation();
